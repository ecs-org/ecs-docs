...
.. rst:directive:: .. sectionauthor:: name <email>
    ...
    By default, this markup isnt reflected in the output in any way,  but you can set the configuration value **show_authors** to True to make them produce a paragraph in the output.
