...
# -*- coding: utf-8 -*-
#
# ecs-docs documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'ecs-docs', 'ecs-docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ecs-docs', 'ecs-docs Documentation',
     author, 'ecs-docs', 'One line description of project.',
     'Miscellaneous'),
]
